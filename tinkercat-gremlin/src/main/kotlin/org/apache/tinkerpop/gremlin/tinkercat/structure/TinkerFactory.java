...
public final class TinkerFactory {
     ...
     */
    public static TinkerCat createClassic() {
        ...
        conf.setProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
        final TinkerCat g = TinkerCat.open(conf);
        generateClassic(g);
        return g;
    }
     ...
     */
    public static void generateClassic(final TinkerCat g) {
     ...
     */
    public static TinkerCat createModern() {
        final TinkerCat g = getTinkerCatWithNumberManager();
        generateModern(g);
        return g;
    }
     ...
     */
    public static void generateModern(final TinkerCat g) {
     ...
     */
    public static TinkerCat createTheCrew() {
        final Configuration conf = getNumberIdManagerConfiguration();
        conf.setProperty(TinkerCat.GREMLIN_TINKERGRAPH_DEFAULT_VERTEX_PROPERTY_CARDINALITY, VertexProperty.Cardinality.list.name());
        final TinkerCat g = TinkerCat.open(conf);
        generateTheCrew(g);
        return g;
    }
     ...
     */
    public static void generateTheCrew(final TinkerCat g) {
        ...
        final Vertex tinkercat = g.addVertex(T.id, 11, T.label, "software", "name", "tinkercat");
     ...
     */
    public static TinkerCat createKitchenSink() {
        final TinkerCat g = getTinkerCatWithNumberManager();
     ...
     */
    public static void generateKitchenSink(final TinkerCat graph) {
     ...
     */
    public static TinkerCat createGratefulDead() {
        final TinkerCat g = getTinkerCatWithNumberManager();
     ...
     */
    public static void generateGratefulDead(final TinkerCat graph) {
    ...
    private static TinkerCat getTinkerCatWithNumberManager() {
        final Configuration conf = getNumberIdManagerConfiguration();
        return TinkerCat.open(conf);
    }
