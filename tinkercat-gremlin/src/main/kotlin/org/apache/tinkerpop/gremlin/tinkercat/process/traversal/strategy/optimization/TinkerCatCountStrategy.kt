...
/**
 * This strategy will do a direct {@link org.apache.tinkerpop.gremlin.tinkercat.structure.TinkerHelper#getVertices}
 ...
 * </pre>
 */
public final class TinkerCatCountStrategy extends AbstractTraversalStrategy<TraversalStrategy.ProviderOptimizationStrategy> implements TraversalStrategy.ProviderOptimizationStrategy {

    private static final TinkerCatCountStrategy INSTANCE = new TinkerCatCountStrategy();

    private TinkerCatCountStrategy() {
    }
    ...
    public Set<Class<? extends ProviderOptimizationStrategy>> applyPost() {
        return Collections.singleton(TinkerCatStepStrategy.class);
    }

    public static TinkerCatCountStrategy instance() {
        return INSTANCE;
    }
}
