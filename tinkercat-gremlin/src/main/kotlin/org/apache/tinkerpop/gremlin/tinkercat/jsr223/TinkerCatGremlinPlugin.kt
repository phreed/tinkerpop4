...
import org.apache.tinkerpop.gremlin.tinkercat.jsr223.TinkerCatGremlinPlugin
import org.apache.tinkerpop.gremlin.tinkercat.process.computer.*
...
object TinkerCatGremlinPlugin : AbstractGremlinPlugin("") {
    ...
    private val imports: ImportCustomizer = DefaultImportCustomizer.build()
        .addClassImports(
            ...
            TinkerIoRegistryV1d0::class.java,
            TinkerIoRegistryV2d0::class.java,
            TinkerIoRegistryV3d0::class.java,
