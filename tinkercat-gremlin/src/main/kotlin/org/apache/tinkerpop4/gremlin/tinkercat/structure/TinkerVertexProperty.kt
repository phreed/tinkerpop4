...
open class TinkerVertexProperty<V>(
    ...
    var properties: MutableMap<String, Property<Any>>? = null
    ...
    override fun <U> property(key: String): Property<U> {
        return if (null == properties) Property.empty()
            else properties!!.getOrDefault(key, Property.empty<U>()) as Property<U>
    }
    ...
    override fun <U> property(key: String, value: U): Property<U> {
        ...
        properties!![key] = property as Property<Any>
        return property
    }
    ...
    override fun <U> properties(vararg propertyKeys: String): Iterator<Property<U>> {
        ...
        return  if (propertyKeys.size == 1) {
            val property = properties!![propertyKeys[0]]
            if (null == property) Collections.emptyIterator() else IteratorUtils.of(property) as Iterator<Property<U>>
        } else properties!!.entries.stream().filter { (key1): Map.Entry<String, Property<*>> ->
            ElementHelper.keyExists(key1, *propertyKeys)
        }
            .map { (_, value1): Map.Entry<String, Property<*>> -> value1 }
            .collect(Collectors.toList()).iterator() as Iterator<Property<U>>
    }
}