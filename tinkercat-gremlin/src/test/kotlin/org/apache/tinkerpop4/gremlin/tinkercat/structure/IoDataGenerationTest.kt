...
import org.apache.tinkerpop4.gremlin.tinkercat.structure.TinkerCatTest
...
import org.apache.tinkerpop4.gremlin.structure.io.gryo.GryoVersion
...
import org.apache.tinkerpop4.gremlin.algorithm.generator.DistributionGenerator
import org.apache.tinkerpop4.gremlin.algorithm.generator.PowerLawDistribution
import org.apache.tinkerpop4.gremlin.structure.io.gryo.GryoReader
import org.apache.tinkerpop4.gremlin.AbstractGremlinTest
...
class IoDataGenerationTest {
    ...
    fun shouldWriteGratefulDead() {
        ...
        final GraphReader reader = org.apache.tinkerpop4.gremlin.structure.io.graphson.GraphSONReader.build().mapper(mapper).create();
