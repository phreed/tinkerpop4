...
public class TinkerCatIdManagerTest {
    ...
    public static class NumberIdManagerTest {
        ...
        public static void setup() {
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());
            longIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.LONG.name());

            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
            integerIdManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.INTEGER.name());
        }

        @Test
        public void shouldUseLongIdManagerToCoerceTypes() {
            final Graph graph = TinkerCat.open(longIdManagerConfig);
        ...
        public void shouldUseIntegerIdManagerToCoerceTypes() {
            final Graph graph = TinkerCat.open(integerIdManagerConfig);
            final Vertex v = graph.addVertex(T.id, vertexIdValue);
            final VertexProperty vp = v.property(VertexProperty.Cardinality.single, "test", "value", T.id, vertexPropertyIdValue);
            final Edge e = v.addEdge("self", v, T.id, edgeIdValue);
    ...
    public static class UuidIdManagerTest {
        ...
        @BeforeClass
        public static void setup() {
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_EDGE_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
            idManagerConfig.addProperty(TinkerCat.GREMLIN_TINKERGRAPH_VERTEX_PROPERTY_ID_MANAGER, TinkerCat.DefaultIdManager.UUID.name());
        }

        @Test
        public void shouldUseIdManagerToCoerceTypes() {
            final Graph graph = TinkerCat.open(idManagerConfig);
            final Vertex v = graph.addVertex(T.id, vertexIdValue);
            final VertexProperty vp = v.property(VertexProperty.Cardinality.single, "test", "value", T.id, vertexPropertyIdValue);
            final Edge e = v.addEdge("self", v, T.id, edgeIdValue);
