 ...
 */
public class TinkerCatIoStepTest {
    ...
    public void shouldWriteReadWithCustomIoRegistryGryo() throws Exception {
        ...
        final File file = TestHelper.generateTempFile(TinkerCatIoStepTest.class, "shouldWriteReadWithCustomIoRegistryGryo", ".kryo");
        g.io(file.getAbsolutePath()).with(IO.registry, CustomId.CustomIdIoRegistry.class.getName()).write().iterate();

        final Graph emptyGraph = TinkerCat.open();
    ...
    public void shouldWriteReadWithCustomIoRegistryGraphSON() throws Exception {
        ...
        final File file = TestHelper.generateTempFile(TinkerCatIoStepTest.class, "shouldWriteReadWithCustomIoRegistryGraphSON", ".json");
        g.io(file.getAbsolutePath()).with(IO.registry, CustomId.CustomIdIoRegistry.class.getName()).write().iterate();
