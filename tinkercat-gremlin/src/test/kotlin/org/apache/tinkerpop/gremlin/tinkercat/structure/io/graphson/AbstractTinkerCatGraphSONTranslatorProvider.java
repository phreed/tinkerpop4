...
@Graph.OptOut(
        ...
        reason = "This test returns BulkSet which isn't supported in GraphSON 3.0 until 3.4.0.")
public abstract class AbstractTinkerCatGraphSONTranslatorProvider extends TinkerCatProvider {

    private final GraphSONVersion version;

    AbstractTinkerCatGraphSONTranslatorProvider(final GraphSONVersion version) {
    ...
    public static class TinkerCatGraphSONv2TranslatorProvider extends AbstractTinkerCatGraphSONTranslatorProvider {
        public TinkerCatGraphSONv2TranslatorProvider() {
            super(GraphSONVersion.V2_0);
        }
    }

    public static class TinkerCatGraphSONv3TranslatorProvider extends AbstractTinkerCatGraphSONTranslatorProvider {
        public TinkerCatGraphSONv3TranslatorProvider() {
    ...
    @Graph.OptOut(
            ...
            reason = "Reason requires investigation")
    public static class TinkerCatGraphSONv2TranslatorComputerProvider extends TinkerCatGraphSONv2TranslatorProvider {
    ...
    @Graph.OptOut(
            ...
            method = "shouldSucceedWithProperTraverserRequirements",
            reason = "Reason requires investigation")
    public static class TinkerCatGraphSONv3TranslatorComputerProvider extends TinkerCatGraphSONv3TranslatorProvider {
