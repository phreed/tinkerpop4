...
/**
 * Unit tests for [TinkerIoRegistryV1d0.TinkerCatGryoSerializer]
 */
@RunWith(MockitoJUnitRunner::class)
class TinkerCatGryoSerializerV1d0Test {
    @Mock
    ...
    private val serializer = TinkerIoRegistryV1d0.TinkerCatGryoSerializer()
    @Before
