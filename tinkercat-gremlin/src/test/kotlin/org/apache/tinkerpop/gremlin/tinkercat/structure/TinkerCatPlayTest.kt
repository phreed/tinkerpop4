 ...
 */
public class TinkerCatPlayTest {
    private static final Logger logger = LoggerFactory.getLogger(TinkerCatPlayTest.class);
    ...
    public void testPlay7() throws Exception {
        ...
        TinkerCat graph = TinkerFactory.createModern();
        GraphTraversalSource g = graph.traversal();
