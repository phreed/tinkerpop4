...
class StructureElementVisitor private constructor() : GremlinBaseVisitor<Element?>() {
    @Override
    fun visitStructureVertex(ctx: StructureVertexContext): Vertex {
    ...
    companion object {
        private var instance: StructureElementVisitor? = null
        fun instance(): StructureElementVisitor? {
            if (instance == null) {
                instance = StructureElementVisitor()
            }
            return instance
        }
    }
