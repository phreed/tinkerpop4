...
interface KryoShimService {
     ...
     * @return the first deserialized object available from `source`
     */
    fun readClassAndObject(source: InputStream?): Object?
     ...
     */
    fun writeClassAndObject(o: Object?, sink: OutputStream?)

    /**
     * Returns this service's relative priority number.  Unless explicitly overridden through a
     * system property ([KryoShimServiceLoader.KRYO_SHIM_SERVICE]),
