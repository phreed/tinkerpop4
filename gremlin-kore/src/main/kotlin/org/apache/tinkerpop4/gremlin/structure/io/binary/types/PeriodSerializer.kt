 ...
 */
class PeriodSerializer : SimpleTypeSerializer<Period?>(DataType.PERIOD) {
    @Override
    @Throws(IOException::class)
    protected fun readValue(buffer: Buffer, context: GraphBinaryReader?): Period {
        return Period.of(buffer.readInt(), buffer.readInt(), buffer.readInt())
    }

    @Override
    @Throws(IOException::class)
    protected fun writeValue(value: Period, buffer: Buffer, context: GraphBinaryWriter?) {
