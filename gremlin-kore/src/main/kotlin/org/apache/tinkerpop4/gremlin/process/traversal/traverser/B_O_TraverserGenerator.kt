 ...
 */
class B_O_TraverserGenerator private constructor() : TraverserGenerator {
    @Override
    fun <S> generate(start: S, startStep: Step<S, *>?, initialBulk: Long): Traverser.Admin<S> {
        return B_O_Traverser(start, initialBulk)
    }
    ...
    companion object {
        ...
        private val INSTANCE = B_O_TraverserGenerator()
        fun instance(): B_O_TraverserGenerator {
            return INSTANCE
        }
    }
}