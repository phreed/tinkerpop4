 ...
 */
class O_OB_S_SE_SL_TraverserGenerator private constructor() : TraverserGenerator {
    @Override
    fun <S> generate(start: S, startStep: Step<S, *>?, initialBulk: Long): Traverser.Admin<S> {
        return O_OB_S_SE_SL_Traverser(start, startStep)
    }
    ...
    companion object {
        ...
        private val INSTANCE = O_OB_S_SE_SL_TraverserGenerator()
        fun instance(): O_OB_S_SE_SL_TraverserGenerator {
            return INSTANCE
        }
    }
}