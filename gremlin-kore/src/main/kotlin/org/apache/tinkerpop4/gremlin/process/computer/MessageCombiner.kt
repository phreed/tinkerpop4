 ...
 * Not all messages can be combined and thus, this is an optional feature of a [VertexProgram].
 *
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 */
interface MessageCombiner<M> : Serializable {
    /**
     ...
     */
    fun combine(messageA: M, messageB: M): M
}