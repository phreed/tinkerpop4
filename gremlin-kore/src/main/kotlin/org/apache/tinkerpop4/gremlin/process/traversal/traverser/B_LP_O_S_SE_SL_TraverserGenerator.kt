 ...
 */
class B_LP_O_S_SE_SL_TraverserGenerator private constructor() : TraverserGenerator {
    @Override
    fun <S> generate(start: S, startStep: Step<S, *>?, initialBulk: Long): Traverser.Admin<S> {
        return B_LP_O_S_SE_SL_Traverser(start, startStep, initialBulk)
    }
    ...
    companion object {
        private val INSTANCE = B_LP_O_S_SE_SL_TraverserGenerator()
        ...
        fun instance(): B_LP_O_S_SE_SL_TraverserGenerator {
            return INSTANCE
        }
    }
}