...
class ConstantStep<S, E>(traversal: Traversal.Admin?, val constant: E) : ScalarMapStep<S, E>(traversal) {
    ...
    override fun toString(): String {
        return StringFactory.stepString(this, constant)
    }

    @Override
    override fun hashCode(): Int {
        return super.hashCode() xor Objects.hashCode(constant)
    }
}