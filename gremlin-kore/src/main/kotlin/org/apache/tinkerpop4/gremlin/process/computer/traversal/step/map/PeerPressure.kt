...
object PeerPressure {
     ...
     */
    val times: String = Graph.Hidden.hide("tinkerpop.peerPressure.times")

    /**
     * Configures the edge to traverse when determining clusters.
     */
    val edges: String = Graph.Hidden.hide("tinkerpop.peerPressure.edges")

    /**
     * Configures the name of the property within which to store the cluster value.
     */
    val propertyName: String = Graph.Hidden.hide("tinkerpop.peerPressure.propertyName")
}