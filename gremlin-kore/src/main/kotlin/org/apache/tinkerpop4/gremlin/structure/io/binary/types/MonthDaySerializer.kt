 ...
 */
class MonthDaySerializer : SimpleTypeSerializer<MonthDay?>(DataType.MONTHDAY) {
    @Override
    @Throws(IOException::class)
    protected fun readValue(buffer: Buffer, context: GraphBinaryReader?): MonthDay {
        return MonthDay.of(buffer.readByte(), buffer.readByte())
    }

    @Override
    @Throws(IOException::class)
    protected fun writeValue(value: MonthDay, buffer: Buffer, context: GraphBinaryWriter?) {
