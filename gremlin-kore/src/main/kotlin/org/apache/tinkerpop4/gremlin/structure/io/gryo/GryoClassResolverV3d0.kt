 ...
 */
class GryoClassResolverV3d0 : AbstractGryoClassResolver() {
    @Override
    fun coerceType(clazz: Class): Class {
        ...
        type =
            ...
            ) InetAddress::class.java else if (ConnectiveP::class.java.isAssignableFrom(clazz)) P::class.java else if (Metrics::class.java.isAssignableFrom(
                    clazz
                )
            ) Metrics::class.java else if (TraversalMetrics::class.java.isAssignableFrom(clazz)) TraversalMetrics::class.java else clazz
        return type
    }
}