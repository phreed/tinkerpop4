...
object ConnectedComponent {
     ...
     */
    val component: String = ConnectedComponentVertexProgram.COMPONENT

    /**
     * Configures the edge to traverse when calculating the pagerank.
     */
    val edges: String = Graph.Hidden.hide("tinkerpop.connectedComponent.edges")

    /**
     * Configures the name of the property within which to store the pagerank value.
     */
    val propertyName: String = Graph.Hidden.hide("tinkerpop.connectedComponent.propertyName")
}