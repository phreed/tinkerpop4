...
import org.apache.tinkerpop4.gremlin.process.computer.clustering.connected.ConnectedComponentVertexProgram;
import org.apache.tinkerpop4.gremlin.process.computer.traversal.step.map.ConnectedComponentVertexProgramStep;
import org.apache.tinkerpop4.gremlin.process.computer.traversal.step.map.PageRankVertexProgramStep;
import org.apache.tinkerpop4.gremlin.process.computer.traversal.step.map.PeerPressureVertexProgramStep;
import org.apache.tinkerpop4.gremlin.process.computer.traversal.step.map.ProgramVertexProgramStep;
import org.apache.tinkerpop4.gremlin.process.computer.traversal.step.map.ShortestPathVertexProgramStep;
...
import org.apache.tinkerpop4.gremlin.process.traversal.lambda.LoopTraversal;
import org.apache.tinkerpop4.gremlin.process.traversal.lambda.PredicateTraverser;
import org.apache.tinkerpop4.gremlin.process.traversal.lambda.TrueTraversal;
import org.apache.tinkerpop4.gremlin.process.traversal.step.ByModulating;
import org.apache.tinkerpop4.gremlin.process.traversal.step.Configuring;
import org.apache.tinkerpop4.gremlin.process.traversal.step.FromToModulating;
import org.apache.tinkerpop4.gremlin.process.traversal.step.Mutating;
import org.apache.tinkerpop4.gremlin.process.traversal.step.ReadWriting;
import org.apache.tinkerpop4.gremlin.process.traversal.step.TimesModulating;
import org.apache.tinkerpop4.gremlin.process.traversal.step.TraversalOptionParent;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.BranchStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.ChooseStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.LocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.OptionalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.RepeatStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.branch.UnionStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.AndStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.CoinStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.ConnectiveStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.DedupGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.DropStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.HasStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.IsStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.LambdaFilterStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.NoneStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.NotStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.OrStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.PathFilterStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.RangeGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.SampleGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.TailGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.TimeLimitStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.TraversalFilterStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.WherePredicateStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.filter.WhereTraversalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.AddEdgeStartStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.AddEdgeStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.AddVertexStartStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.AddVertexStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.CoalesceStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.ConstantStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.CountGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.CountLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.DedupLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.EdgeOtherVertexStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.EdgeVertexStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.ElementMapStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.FoldStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.GraphStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.GroupCountStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.GroupStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.IdStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.IndexStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.LabelStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.LambdaCollectingBarrierStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.LambdaFlatMapStep;
...
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MatchStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MathStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MaxGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MaxLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MeanGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MeanLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MinGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.MinLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.NoOpBarrierStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.OrderGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.OrderLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.PathStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.ProjectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.PropertiesStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.PropertyKeyStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.PropertyMapStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.PropertyValueStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.RangeLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SackStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SampleLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SelectOneStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SelectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SumGlobalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.SumLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.TailLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.TraversalFlatMapStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.TraversalMapStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.TraversalSelectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.TreeStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.UnfoldStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.map.VertexStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.AddPropertyStep;
...
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.GroupCountSideEffectStep;
...
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.InjectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.IoStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.LambdaSideEffectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.ProfileSideEffectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.SackValueStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.SideEffectCapStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.StartStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.AggregateLocalStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.SubgraphStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.TraversalSideEffectStep;
import org.apache.tinkerpop4.gremlin.process.traversal.step.sideEffect.TreeSideEffectStep;
...
import org.apache.tinkerpop4.gremlin.process.traversal.step.util.WithOptions;
...
import org.apache.tinkerpop4.gremlin.process.traversal.util.TraversalMetrics;
...
import org.apache.tinkerpop4.gremlin.structure.PropertyType;
...
import static org.apache.tinkerpop4.gremlin.structure.VertexProperty.Cardinality.single;
...
public interface GraphTraversal<S, E> extends Traversal<S, E> {
     ...
     * and {@link org.apache.tinkerpop4.gremlin.process.traversal.step.util.WithOptions#indexer}.
     *
