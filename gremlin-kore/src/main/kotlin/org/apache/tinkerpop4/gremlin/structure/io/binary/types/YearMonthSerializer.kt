 ...
 */
class YearMonthSerializer : SimpleTypeSerializer<YearMonth?>(DataType.YEARMONTH) {
    @Override
    @Throws(IOException::class)
    protected fun readValue(buffer: Buffer, context: GraphBinaryReader?): YearMonth {
        return YearMonth.of(buffer.readInt(), buffer.readByte())
    }

    @Override
    @Throws(IOException::class)
    protected fun writeValue(value: YearMonth, buffer: Buffer, context: GraphBinaryWriter?) {
