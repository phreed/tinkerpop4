...
/**
 * Provides a way to customize and override [Bytecode] to script translation. Not all [GremlinScriptEngine]
 * will support this capability as translation is optional.
 *
 * @author Stephen Mallette (http://stephen.genoprime.com)
 */
interface TranslatorCustomizer : Customizer {
    /**
     * Construct a [Translator.ScriptTranslator.TypeTranslator] that will be used by a
     * [Translator.ScriptTranslator] instance within the [GremlinScriptEngine] to translate
     * [Bytecode] to a script.
     */
    fun createTypeTranslator(): TypeTranslator?
}