 ...
 */
class OffsetDateTimeSerializer : SimpleTypeSerializer<OffsetDateTime?>(DataType.OFFSETDATETIME) {
    @Override
    @Throws(IOException::class)
    protected fun readValue(buffer: Buffer?, context: GraphBinaryReader): OffsetDateTime {
    ...
    @Override
    @Throws(IOException::class)
    protected fun writeValue(value: OffsetDateTime, buffer: Buffer?, context: GraphBinaryWriter) {
