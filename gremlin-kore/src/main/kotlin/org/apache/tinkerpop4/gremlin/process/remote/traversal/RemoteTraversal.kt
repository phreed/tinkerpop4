...
/**
 * A [RemoteTraversal] is returned from [RemoteConnection.submitAsync]. It is iterated from
 * within [RemoteStep] using [.nextTraverser]. Implementations should typically be given a "result" from
 ...
 */
interface RemoteTraversal<S, E> : Traversal.Admin<S, E>