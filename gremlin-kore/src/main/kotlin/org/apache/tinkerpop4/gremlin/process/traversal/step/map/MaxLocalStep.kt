...
import org.apache.tinkerpop4.gremlin.util.NumberHelper.max

/**
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 * @author Daniel Kuppitz (http://gremlin.guru)
 */
class MaxLocalStep<E : Comparable?, S : Iterable<E>?>(traversal: Traversal.Admin?) : ScalarMapStep<S, E>(traversal) {
    @Override
