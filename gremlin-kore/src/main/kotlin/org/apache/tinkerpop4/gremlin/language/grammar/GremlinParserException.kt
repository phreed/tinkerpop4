 ...
 */
class GremlinParserException : RuntimeException {
    constructor(message: String?, cause: Throwable?) : super(message, cause) {}
    constructor(message: String?) : super(message) {}
    constructor(line_number: Int, charPositionInLine: Int, message: String?) : super(
        StringBuilder()
    ...
    companion object {
        private const val serialVersionUID = 13748205730257427L
    }
}