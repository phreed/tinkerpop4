 ...
 */
class BulkSetSerializer : SimpleTypeSerializer<BulkSet?>(DataType.BULKSET) {
    @Override
    @Throws(IOException::class)
    protected fun readValue(buffer: Buffer, context: GraphBinaryReader): BulkSet {
    ...
    @Override
    @Throws(IOException::class)
    protected fun writeValue(value: BulkSet, buffer: Buffer, context: GraphBinaryWriter) {
        val raw: Map<Object, Long> = value.asBulk()
