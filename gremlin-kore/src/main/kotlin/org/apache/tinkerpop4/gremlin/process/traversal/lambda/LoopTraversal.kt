 ...
 */
class LoopTraversal<S>(val maxLoops: Long) : AbstractLambdaTraversal<S, S>() {
    ...
    override fun hashCode(): Int {
        return this.getClass().hashCode() xor Long.hashCode(maxLoops)
    }

    @Override
    override fun equals(other: Object): Boolean {
        return (other is LoopTraversal<*>
                && (other as LoopTraversal<*>).maxLoops == maxLoops)
    }
}