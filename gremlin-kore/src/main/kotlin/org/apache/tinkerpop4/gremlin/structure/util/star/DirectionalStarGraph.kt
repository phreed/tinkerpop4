...
class DirectionalStarGraph(starGraphToSerialize: StarGraph, direction: Direction) {
    private val direction: Direction
    private val starGraphToSerialize: StarGraph
    ...
    fun getStarGraphToSerialize(): StarGraph {
