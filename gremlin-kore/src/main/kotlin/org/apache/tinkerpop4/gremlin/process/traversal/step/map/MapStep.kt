 ...
 * [Traverser] into another. In many cases, it may be easier to simply extend from [ScalarMapStep] which
 * has a straightforward implementation pattern.
 *
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 * @author Stephen Mallette (http://stephen.genoprime.com)
 */
abstract class MapStep<S, E>(traversal: Traversal.Admin?) : AbstractStep<S, E>(traversal)