 ...
 */
class LP_O_OB_P_S_SE_SL_TraverserGenerator private constructor() : TraverserGenerator {
    @Override
    fun <S> generate(start: S, startStep: Step<S, *>?, initialBulk: Long): Traverser.Admin<S> {
        return LP_O_OB_P_S_SE_SL_Traverser(start, startStep)
    }
    ...
    companion object {
        ...
        private val INSTANCE = LP_O_OB_P_S_SE_SL_TraverserGenerator()
        fun instance(): LP_O_OB_P_S_SE_SL_TraverserGenerator {
            return INSTANCE
        }
    }
}