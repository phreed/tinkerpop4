...
import org.apache.tinkerpop4.gremlin.process.traversal.Bindings;
...
import static org.apache.tinkerpop4.gremlin.process.traversal.GraphOp.TX_COMMIT;
import static org.apache.tinkerpop4.gremlin.process.traversal.GraphOp.TX_ROLLBACK;
