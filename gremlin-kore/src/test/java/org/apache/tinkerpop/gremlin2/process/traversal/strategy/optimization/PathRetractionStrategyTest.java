...
import org.apache.tinkerpop4.gremlin.process.traversal.step.PathProcessor;
...
import static org.apache.tinkerpop4.gremlin.process.traversal.P.gte;
import static org.apache.tinkerpop4.gremlin.process.traversal.P.neq;
import static org.apache.tinkerpop4.gremlin.process.traversal.P.without;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.as;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.bothE;
...
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.project;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.select;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.store;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.values;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.where;
