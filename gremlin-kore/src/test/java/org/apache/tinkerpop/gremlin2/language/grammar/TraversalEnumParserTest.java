    ...
    public static class EnumTest {
        ...
        public static Iterable<Object[]> generateTestParameters() {
            return Arrays.asList(new Object[][]{
                    {"org.apache.tinkerpop4.gremlin.process.traversal.Scope", "traversalScope"},
                    {"org.apache.tinkerpop4.gremlin.process.traversal.Order", "traversalOrder"},
                    {"org.apache.tinkerpop4.gremlin.process.traversal.Pop", "traversalPop"},
                    {"org.apache.tinkerpop4.gremlin.process.traversal.SackFunctions$Barrier", "traversalSackMethod"},
                    {"org.apache.tinkerpop4.gremlin.process.traversal.Operator", "traversalOperator"},
                    {"org.apache.tinkerpop4.gremlin.structure.T", "traversalToken"},
                    {"org.apache.tinkerpop4.gremlin.structure.Column", "traversalColumn"},
                    {"org.apache.tinkerpop4.gremlin.structure.Direction", "traversalDirection"},
                    {"org.apache.tinkerpop4.gremlin.structure.VertexProperty$Cardinality", "traversalCardinality"},
                    {"org.apache.tinkerpop4.gremlin.process.traversal.step.TraversalOptionParent$Pick", "traversalOptionParent"},
            });
        }
