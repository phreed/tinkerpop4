...
import org.apache.tinkerpop4.gremlin.process.traversal.strategy.decoration.SeedStrategy;
import org.apache.tinkerpop4.gremlin.process.traversal.strategy.decoration.SubgraphStrategy;
import org.apache.tinkerpop4.gremlin.process.traversal.strategy.verification.ReadOnlyStrategy;
...
import static org.apache.tinkerpop4.gremlin.process.traversal.AnonymousTraversalSource.traversal;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.hasLabel;
import static org.apache.tinkerpop4.gremlin.process.traversal.dsl.graph.Anon.inE;
...
public class PythonTranslatorTest {
    ...
    public void shouldTranslateStrategies() {
        assertEquals("g.withStrategies(*[TraversalStrategy('ReadOnlyStrategy', None, 'org.apache.tinkerpop4.gremlin.process.traversal.strategy.verification.ReadOnlyStrategy'),TraversalStrategy('SubgraphStrategy',{'checkAdjacentVertices':False,'vertices':__.hasLabel('person')}, 'org.apache.tinkerpop4.gremlin.process.traversal.strategy.decoration.SubgraphStrategy'),TraversalStrategy('SeedStrategy',{'seed':999999,'strategy':'org.apache.tinkerpop4.gremlin.process.traversal.strategy.decoration.SeedStrategy'}, 'org.apache.tinkerpop4.gremlin.process.traversal.strategy.decoration.SeedStrategy')]).V().has('name')",
